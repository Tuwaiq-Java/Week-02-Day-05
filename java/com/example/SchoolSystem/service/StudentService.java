...
import com.example.SchoolSystem.controller.Student;
import com.example.SchoolSystem.model.StudentClass;
...
public class StudentService {
    ...
    public Boolean addStudentToClass(String stu_id,String class_id){
        StudentClass curr_stu=studentList.get(findStudentById(stu_id));
